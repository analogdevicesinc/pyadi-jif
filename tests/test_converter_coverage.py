...
class MockConverter(converter):
    ...
    quick_configuration_modes = {"jesd204b": {"1": {"L": 1, "M": 1, "F": 2, "S": 1, "K": 32, "N": 16, "Np": 16}}}
    ...
    N_available = [16]
    Np_available = [16]
    def _check_valid_internal_configuration(self) -> None: pass
    def get_required_clocks(self): return []
    def get_required_clock_names(self): return []
    def get_config(self, solution=None): return {}
