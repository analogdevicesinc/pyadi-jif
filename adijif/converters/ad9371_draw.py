...
class ad9371_rx_draw:
    """AD9371 RX drawing features."""

    _system_draw = False
    show_rates = True

    def _init_diagram(self) -> None:
        """Initialize diagram for AD9371 RX."""
    ...
    def draw(
        ...
        """Draw diagram in d2 language for AD9371 RX.
...
class ad9371_tx_draw:
    """AD9371 TX drawing features."""

    _system_draw = False
    show_rates = True

    def _init_diagram(self) -> None:
        """Initialize diagram for AD9371 TX."""
        self.ic_diagram_node = None
        self._diagram_output_dividers = []
    ...
    def draw(
        ...
        """Draw diagram in d2 language for AD9371 TX.
