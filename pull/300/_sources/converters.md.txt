...
Externally generated converter profiles can be used as the source for datapath,
sample-rate, and JESD204 settings. AD9084 Apollo JSON profiles are imported
directly, while ADRV9009 TES profile values are mapped into the RX and TX
models. See [Using externally generated converter profiles](converter_profiles.md)
for the complete generation, import, solve, and validation process.
